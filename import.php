<?php
/*
Plugin Name: WP Coupon Mate pro Demo Import
...
class WPCoupon_Demo_Import {
    ...
    static function import_menu() {
        add_submenu_page(
            'wpcoupon_options',
            esc_html__( 'Wp Coupon demo content', 'wp-coupon-mate' ),
            esc_html__( 'Demo Content', 'wp-coupon-mate' ),
            'manage_options',
    ...
    static function display( ){
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e( 'WP Coupon demo content', 'wp-coupon-mate' ); ?></h1>
            ...
            <div class="theme_info info-tab-content">
                ...
                <?php if ( get_option( 'wpc_demo_imported' ) == 1 ) { ?>
                    <div class="action-required updated settings-error notice" style="border-left-color: #a1d3a2; clear:both;">
                        <p><?php _e('Demo already imported', 'wp-coupon-mate'); ?></p>
                    </div>
                <?php } ?>
                ...
                <p>
                    ...
                    if( get_option( 'wpc_demo_imported' ) == 1 ) {
                        _e('Import Again', 'wp-coupon-mate');
                    } else {
                        _e('Import Demo Data', 'wp-coupon-mate');
                    }
                    ?>
                    </a>
        ...
        <script type="text/javascript">
            jQuery( document).ready( function( $ ){
                $( '.wpc_demo_import').on( 'click', function( e ){
                    ...
                    var c = confirm( "<?php echo  esc_js(esc_attr__( 'Are you sure want to import demo content ?', 'wp-coupon-mate' ) ); ?>" );
                   // var c = true;
                    if ( c ) {
